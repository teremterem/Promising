# TODO TODO TODO Compare to tests for @promising.function and split into sync
#  and async test files
import pytest
...
async def test_sync_function_decorator_without_parens() -> None:
    """
